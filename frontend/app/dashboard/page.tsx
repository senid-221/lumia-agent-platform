...
import { Bot, Bell, CheckCircle2, ChevronRight, FileText, Landmark, MessageSquare, Search, UserRound } from 'lucide-react';
    ...
    <main className="min-h-screen bg-slate-50 text-slate-950">
      ...
      <div className="mx-auto max-w-7xl px-5 py-10 lg:px-8">
        <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
          <div><div className="text-sm font-medium text-slate-500">CUSTOMER WORKSPACE</div><h1 className="mt-2 text-4xl font-semibold tracking-tight">Good to see you.</h1><p className="mt-2 text-slate-600">Choose what you want to get done today.</p></div>
