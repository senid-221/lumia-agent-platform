...
type Product = { id:string; name:string; category:string; description:string|null; priceRwf:number|null; imageUrl:string|null; stock:number; partner:{businessName:string; location:string} };
